                ...
                <Grid>
                    <Row className="show-grid">
                        <Col xs={12}>
                            ...
                            <p>All of the hop statistics, such as AA’s, hop use, and boil time are are accounted for in
                            ...
                            <p>Instead of creating a categorical variable for each different ingredient, we made a
                            ...
                            <p>In addition to the features we engineered above, we also included a number of variables
                            ...
                            <ul>
                                ...
                                <li>Gravity difference - the difference between original and final gravity, an indicator of
                            ...
                            <p>The first modification we made to our data was to drop every row without a rating.
                            ...
                            <p>To find if certain features were more related to helping predict rating values we
                            ...
                            <h2>Outliers</h2>
                            <p>The data that we are using for this project was scraped from a website where all the
